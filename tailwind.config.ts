...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        // เพิ่ม Prefix 'ori-' ให้ตรงกับตัวแปร CSS ใน globals.css
        'ori-green': '#2D6A2D',
        'ori-green-l': '#4A8C3F',
        'ori-green-bg': '#E8F3E8',
        'ori-green-d': '#1A4A1A',
        ...
        // (ชุดสีเดิม เผื่อมี Component ไหนยังใช้อยู่ จะได้ไม่พัง)
        'paper-cream': '#F5EDD8',
        'paper-cream-d': '#EDE0C4',
        'paper-white': '#FAF6EE',
        'ink': '#1A1208',
        'ink-mid': '#3D2E18',
        'ink-light': '#7A6A50',
        'ink-faint': '#B0A090',
        'wagashi-sakura': '#F2AABF',
        'wagashi-matcha': '#9EC4A0',
        'wagashi-kinako': '#E8C87A',
        'wagashi-sora': '#A8C5E0',
        'washi': '#FAF7F2',
      },
      fontFamily: {
      ...
      boxShadow: {
        'paper-sm': '2px 2px 0 #1A1208',
        'paper': '4px 4px 0 #1A1208',
        'paper-md': '5px 5px 0 #1A1208',
        'paper-lg': '6px 6px 0 #1A1208',
        'paper-xl': '8px 8px 0 #1A1208',
      ...
      borderRadius: { 
        ...
        'ori-lg': '20px',
        'ori-xl': '28px',
        'ori-pill': '9999px', // เพิ่มค่านี้เพื่อให้ตรงกับคลาส rounded-ori-pill ใน CSS
        'pill': '999px'
      },
      borderWidth: { 
        '2.5': '2.5px',
