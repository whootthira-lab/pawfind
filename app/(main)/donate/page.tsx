    ...
    <div className="max-w-5xl mx-auto px-4 py-8 flex flex-col gap-8 mb-20">
      ...
      <div className="bg-wagashi-kinako border-4 border-ori-ink rounded-3xl p-8 md:p-12 shadow-paper text-center relative overflow-hidden">
        ...
        <p className="text-xl md:text-2xl font-bold text-ori-orange-d mb-6">
          เราดำเนินการตามแนวทางของธุรกิจแบบ Pay it Forward เพื่อให้สังคมดีขึ้นด้วยการเป็นผู้ให้ก่อน แล้วผู้ที่ได้รับจะส่งต่อสิ่งดีๆต่อไปให้ผู้อื่น
        </p>
        <div className="bg-white/90 p-6 md:p-8 rounded-2xl border-4 border-ori-ink text-left shadow-paper-sm">
          <p className="font-bold text-lg leading-relaxed text-ori-ink-m">
            ...
            <span className="text-ori-ink font-black bg-ori-yellow/30 px-2 rounded mx-1"> Pay it Forward </span> 
            ที่มุ่งเน้นให้ทุกคนใน Ecosystem สามารถอยู่ได้และเติบโตได้อย่างยั่งยืน เราผสานเทคโนโลยี นวัตกรรม และความเป็นมนุษย์ที่มีความเชื่อว่าเราช่วยให้สิ่งรอบตัวและสังคมน่าอยู่ขึ้นได้โดยเริ่มจากจุดเล็กๆที่เราทำได้ สู่การสร้างสิ่งดีๆและร่วมกันส่งต่อความหวังให้ค่อยๆ ขยายกว้างขึ้นเรื่อยๆ เพื่อยกระดับคุณภาพชีวิตของทั้งสัตว์เลี้ยงและผู้คนอย่างยั่งยืน
          </p>
        </div>
      </div>
