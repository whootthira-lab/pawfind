    ...
    <div className="flex flex-col gap-14 pb-20 text-black">
      ...
      <section className="bg-wagashi-sora border-4 border-black rounded-3xl p-8 shadow-paper max-w-6xl mx-auto w-full mx-4 xl:mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <a href="https://www.youtube.com/@PobPet_th" target="_blank" rel="noreferrer" className="flex items-center gap-3 bg-white border-2 border-black p-4 rounded-xl font-bold shadow-paper-sm hover:scale-105 transition-all text-black">
